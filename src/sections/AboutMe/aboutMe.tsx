    ...
    <>
      <div className={styles.aboutMeContainer}>
        ...
        <p className={styles.aboutMePara}>
          ...
          graphics that are not only functional, but also aesthetically
          pleasing. This blend of design and development enables me to craft
          seamless digital experiences while continuously striving to grow in my
          field.
        </p>
